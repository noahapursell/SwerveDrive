...
public class ShootBallCommand extends CommandBase {
  ...
  public void execute() {
    ...
    if(tv==0.0){
      ...
      // Set motor speeds
      RobotContainer.topShooterMotor.set(ControlMode.Velocity, topMotorPower);
      RobotContainer.bottomShooterMotor.set(ControlMode.Velocity, bottomMotorPower);
    }
  }
  ...
  public void end(boolean interrupted) {
    RobotContainer.bottomShooterMotor.stopMotor();
